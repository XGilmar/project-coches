package com.example.coches.persistance.mapper;

import com.example.coches.domain.pojo.MarcaCochePojo;
import com.example.coches.persistance.entity.MarcaCocheEntity;
...
public interface MarcaCocheMapper {
